...
namespace BookRentalShopApp
{
    public partial class FrmBooks : MetroForm
    {
        ...
        private void InitCboData()
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(Helper.Common.Connstring))
                {
                    ...
                    SqlDataReader reader = cmd.ExecuteReader(); // 쿼리문 실행 후 reader에 결과값이 넘어옴
                    ...
                    CboDivision.ValueMember = "Key"; // key값은 숨어있음
        ...
        private void AsignToControls(DataGridViewRow selData)
        {
            ...
            CboDivision.SelectedValue = selData.Cells[2].Value; //BOO1 = B001
            // selData.Cells[3] X
        ...
        private void RefreshData() // 화면 조회
        {
            ...
            column = DgvData.Columns[8]; //Descriptions 컬럼
            column.Visible = false; // 안보이게 설정
        ...
        private void SaveData()
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(Helper.Common.Connstring))
                {
                    ...
                    pDivision.Value = CboDivision.SelectedValue; //B0011
                    ...
                    pDescriptions.Value = Helper.Common.ReplaceCmdText(TxtDiscriptions.Text); //ReplaceCmdText에 discriptions.text 값을 집어넣음
        ...
        private void ClearInputs()
        {
            ...
            TxtPrice.Text = TxtDiscriptions.Text = "";
            CboDivision.SelectedIndex = -1;
