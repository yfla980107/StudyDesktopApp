...
namespace StudyHistoryApp
{
    public partial class FrmMain : Form
    {
        ...
        private void FrmMain_Load(object sender, EventArgs e)
        {
            ...
            TreeNode stuart = new TreeNode("슈트어트 가");
            stuart.Nodes.Add("ANN1", "앤(1707~1714)"); //ANN1은 유일한 key값
        ...
        private void TrvList_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            PcbPhote.Image = null; //픽처박스 초기화
            TxtDescription.Text = string.Empty;

            if (e.Node.Text == "ANN1")
            {
                PcbPhote.Image = Bitmap.FromFile("./Images/Anne.jpg");
            ...
            {
                PcbPhote.Image = Bitmap.FromFile("./Images/King_George_I.jpg");
